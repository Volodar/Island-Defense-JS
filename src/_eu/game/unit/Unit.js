...
//    void applyDamage( /**@type {EU.Unit} */ damager, Number time = 1 );
    ...
    getDamageBySector: function () {
        return this._damageBySector;
    },
    getDamageBySectorAngle: function () {
        return this._damageBySectorAngle;
    },
    getCurrentDamager: function () {
        return this._currentDamager;
    },
    getHealth: function () {
        return this._health;
    },
    ...
    getMaxLevelForLevel: function () {
        return this._maxLevelForLevel;
    },
    ...
    loadXmlSkill: function (/** @type {Element} */ xmlnode) {
        /** {String} */ var type = xmlnode.tagName;
    ...
    getMoveFinished: function () {
        return this._moveFinished;
    }
});
